...
- Register a new account with caregiver ID 2 (or alternatively create your own caregiver login and it will be ID 26 (I did a lot of testing with users hence the high ID number!))
